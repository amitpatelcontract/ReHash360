...
public class PostViewHolder extends RecyclerView.ViewHolder {
    ...
    public PostViewHolder(View itemView) {
        super(itemView);
        mView = itemView;
        mPhotoView = (VrPanoramaView) itemView.findViewById(R.id.post_photo);
    ...
    public void setPhoto(String url, Context context, VrPanoramaView.Options panoOptions) {
        mPhotoView.loadImageFromBitmap(GlideUtil.getBitmapFromUrl(url,context), panoOptions);
